...
require (
	...
	github.com/zijiren233/gwst v0.3.5 // indirect
)
...
replace github.com/sagernet/sing-box => github.com/zijiren233/hiddify-sing-box v0.0.0-20241026134809-9b5b6ef3e6d4
